...
public class SpringDataRestApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			// 1. Créer et sauvegarder les propriétaires d'abord
			...
			// 2. Sauvegarder les voitures en leur associant un propriétaire
			// Note : Le dernier argument est l'objet propriétaire créé juste au-dessus
